...
do { \
    ...
    _lf_action_table[0] = (lf_action_base_t*)&federate__bridge_nr_federate__bridge_self[0]->_lf_networkMessage; \
    federate__bridge_nr_federate__bridge_self[0]->_lf_networkMessage.source_id = 39; \
    _lf_action_delay_table[1] = NEVER; \
    _lf_action_table[1] = (lf_action_base_t*)&federate__bridge_nr_federate__bridge_0_self[0]->_lf_networkMessage; \
    federate__bridge_nr_federate__bridge_0_self[0]->_lf_networkMessage.source_id = 39; \
    _lf_action_delay_table[2] = NEVER; \
    _lf_action_table[2] = (lf_action_base_t*)&federate__bridge_nr_federate__bridge_1_self[0]->_lf_networkMessage; \
    federate__bridge_nr_federate__bridge_1_self[0]->_lf_networkMessage.source_id = 39; \
    _lf_action_delay_table[3] = NEVER; \
    _lf_action_table[3] = (lf_action_base_t*)&federate__bridge_nr_federate__bridge_2_self[0]->_lf_networkMessage; \
    federate__bridge_nr_federate__bridge_2_self[0]->_lf_networkMessage.source_id = 39; \
    staa_initialization(); \
} \
while (0)
/**
